...
- **使用以下命令运行脚本**
```
wget -N -O /root/singbox.sh https://github.com/akaagiao1/Script_installation/blob/main/Install.sh && chmod +x /root/singbox.sh && ln -sf /root/singbox.sh /usr/local/bin/singbox && bash /root/singbox.sh
```
